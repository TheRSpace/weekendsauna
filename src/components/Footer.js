    ...
    <div className="footer-container">
      ...
      <div class="footer-links">
        ...
        <div className="footer-link-wrapper">
          ...
          <div class="footer-link-items">
            <h2>Social Media</h2>
            <Link to="https://www.instagram.com/weekendsaunas/">Instagram</Link>
            <Link to="https://www.facebook.com//weekendsauna">Facebook</Link>
          </div>
        </div>
      </div>
      <section class="social-media">
        <div class="social-media-wrap">
          ...
          <div class="social-icons">
            ...
            <Link class="social-icon-link instagram" to="https://www.instagram.com/weekendsaunas/" target="https://www.instagram.com/weekendsaunas/" aria-label="Instagram">
